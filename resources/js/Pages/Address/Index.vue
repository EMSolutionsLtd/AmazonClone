        ...
        <div class="max-w-[1000px] mx-auto flex gap-2 h-[270px]">
            ...
            <div v-if="$page.props.auth.address" class="relative border border-gray-400 rounded-md w-1/3 shadow-md">
                ...
                <div class="px-4 absolute bottom-0 pb-4">
                    <Link :href="route('address_options.destroy', {id: $page.props.auth.address.id})" method="delete" as="button" class="text-teal-700 text-sm font-extrabold hover:underline hover:text-red-700">
                        Remove
                    </Link>
                </div>
            </div>
