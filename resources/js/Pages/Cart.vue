    ...
    <AuthenticatedLayout>
        <div class="flex gap-4">
            <div class="w-full bg-white p-4 mt-4">
                <div class="border-b">
                    <div class="text-[72px] font-semibold">Shopping Cart</div>
            ...
            <div class="bg-white w-[350px] p-4 mt-4 h-48">
                ...
                <Link
                    ...
                    as = "button"
                    method="post"
                    :href="$page.props.auth.user !== null ? route('checkout.store', { total: totalWithoutDot(), total_decimal : total, items : cart }) : route('login')"
                >
                Proceed to checkout
                </Link>
            </div>
