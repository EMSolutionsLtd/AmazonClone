        ...
        <div class="flex items-center bg-gray-900 h-[60px] py-2 fixed z-50 min-w-[1150px] w-full">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <div class="text-[15px] text-white -mt-1.5 font-extrabold">
                                <div v-if="$page.props.auth.address">{{ $page.props.auth.address.city }} {{ $page.props.auth.address.postcode }}</div>
                                <div v-else class="text-[15px] text-white -mt-1.5 font-extrabold">Select your address</div>
                            </div>
                        </div>
                    </div>
                </Link>
            ...
            <div class="flex">
                <div class="h-[50px] p-2 pt-3 border-[1px] border-gray-900 rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                    <div class="flex items-center justify-center mt-0 px-1">
                            ...
                            <div class="flex">
                                ...
                                <div class="w-1/2 ml-5">
                                    <div class="pb-3">
                                        ...
                                        <Link :href="route('profile.edit')" class="block text-sm hover:text-red-600 hover:underline pt-3">Account</Link>
                                        <Link :href="route('logout')" method="post" as="button" class="block text-sm hover:text-red-600 hover:underline pt-3">Sign Out</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
